...
var IoPorts = function IoPorts(_ref2) {
  var nodeId = _ref2.nodeId,
      ...
      resolvedValues = _ref2.resolvedValues;
...
var Output = function Output(_ref5) {
  var label = _ref5.label,
      ...
      localRenderResult = _ref5.renderResult,
      resolvedValue = _ref5.resolvedValue;

  var _ref6 = inputTypes[type] || {},
      defaultLabel = _ref6.label,
      color = _ref6.color,
      defaultRenderResult = _ref6.renderResult;

  var renderResult = localRenderResult || defaultRenderResult;
  ...
  return React__default.createElement(
    ...
    !renderResult && React__default.createElement(
      "label",
      { className: styles$4.portLabel },
      label || defaultLabel
    ),
...
var Node = function Node(_ref) {
  var id = _ref.id,
      ...
      onDragEnd = _ref.onDragEnd,
      onDrag = _ref.onDrag,
      resolvedValues = _ref.resolvedValues;
...
var RootEngine = function () {
  function RootEngine(config, resolveInputControls, fireNodeFunction) {
    ...
    this.getValueOfConnection = function (connection, nodes, context) {
      ...
      var outputResult = _this2.fireNodeFunction(outputNode, inputValues, outputNodeType, context);
      _this2.resultCache[connection.nodeId] = outputResult;
  ...
  createClass(RootEngine, [{
    ...
    key: "resolveAllNodes",
    value: function resolveAllNodes(nodes) {
      var _this4 = this;
      ...
      Object.keys(nodes).forEach(function (key) {
        _this4.getValueOfConnection({ nodeId: key, portName: '' }, nodes, options.context || {});
      });
...
exports.NodeEditor = function NodeEditor(_ref, ref) {
  var initialComments = _ref.comments,
      ...
      debug = _ref.debug,
      _ref$resolvedValues = _ref.resolvedValues,
      resolvedValues = _ref$resolvedValues === undefined ? {} : _ref$resolvedValues;
